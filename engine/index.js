...
import { createAdjacentGame, createNestedGame, GAME_STATUS } from './state.js';

export { createNestedGame, createAdjacentGame, GAME_STATUS } from './state.js';
...
export { getAvailableMovesNested, getAvailableMovesAdjacent };
