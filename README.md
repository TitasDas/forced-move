...
### New mode: Adjacent Constraint (classic remix)
...
- If one of those squares is occupied, your opponent is forced into the other; if both are blocked, they can pick any open square.
- It stays “a game of structure, not speed” because you shape the opponent’s choices every move.
